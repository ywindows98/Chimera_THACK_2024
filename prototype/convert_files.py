...
class Converter:
    ...
    def convert_to_txt(file_path: str, output_directory: str = "data/") -> bool:
        ...
        elif ext in [".docx", ".odt", ".html", ".md", ".epub", "docx", "odt", "html", "md", "epub"]:
    ...
    @staticmethod
    def file_to_dataframe(file_path: str, file_format: str) -> tuple:
        df = pd.DataFrame()
...
#     df, attribute_names, data_types = Converter.file_to_dataframe(file_path, format)
